...
Edge [][] template = new Edge[][] {
  new Edge[] {
    new Edge(new Point(0,0,0),new Point(0.25,0,0)),
    new Edge(new Point(0.75,0,0),new Point(1,0,0)),
    new Edge(new Point(0.25,0,0),new Point(0.25+0.25*cos(PI/3),0.25*sin(PI/3),0)),
    new Edge(new Point(0.25,0,0),new Point(0.25+0.25*cos(PI/3),-0.25*sin(PI/3),0)),
    new Edge(new Point(0.25+0.25*cos(PI/3),0.25*sin(PI/3),0),new Point(0.5+0.25*cos(PI/3),0.25*sin(PI/3),0)),
    new Edge(new Point(0.25+0.25*cos(PI/3),-0.25*sin(PI/3),0),new Point(0.5+0.25*cos(PI/3),-0.25*sin(PI/3),0)),
    new Edge(new Point(0.5+0.25*cos(PI/3),0.25*sin(PI/3),0),new Point(0.75,0,0)),
    new Edge(new Point(0.5+0.25*cos(PI/3),-0.25*sin(PI/3),0),new Point(0.75,0,0))
    },
  new Edge[] {
  ...
  new Edge[] {
    new Edge(new Point(0,0,0),new Point(0.25,0,0)),
    new Edge(new Point(0.25,0,0),new Point(0.5,0.25,0)),
    new Edge(new Point(0.5,0.25,0),new Point(0.75,0,0)),
    new Edge(new Point(0.75,0,0),new Point(1,0,0))
  }
  ,/*
  new Edge[] {
  ...
  new Edge[] {
    new Edge(new Point(0,0,0),new Point(1,0,0),false),
    new Edge(new Point(1,0,0),new Point(1-0.5*cos(PI/2),0.5*sin(PI/2),0)),
  ...
  new Edge[] {
    new Edge(new Point(0,0,0),new Point(1,0,0),false),
    new Edge(new Point(1,0,0),new Point(1-0.5*cos(PI/4),0.5*sin(PI/4),0)),
    new Edge(new Point(1,0,0),new Point(1+cos(PI/4),sin(PI/4),0))
    }
  ,
  new Edge[] {
    new Edge(new Point(0,0,0),new Point(1,0,0),false),
    new Edge(new Point(1,0,0),new Point(1-0.3*cos(PI/32),0.3*sin(PI/32),0)),
    new Edge(new Point(1,0,0),new Point(1+cos(PI/8),sin(PI/8),0))
    }
  ,
  new Edge[] {
    new Edge(new Point(0,0,0),new Point(1,0,0),false),
    new Edge(new Point(1,0,0),new Point(1+0.5*cos(PI/32),0.5*sin(PI/32),0)),
  ...
  ,*/
  new Edge[] {
    new Edge(new Point(0.5,0,0),new Point(0,0,0)),
  ...
  new Edge[] {
    new Edge(new Point(0,0,0),new Point(1,0,0),false),
    new Edge(new Point(1,0,0),new Point(1.5,.5,0)),
    new Edge(new Point(1,0,0),new Point(1.5,-.5,0))
    }
    ,
  new Edge[] {
    new Edge(new Point(1/2.*cos(PI/3),1/2.*sin(PI/3),0),new Point(0,0,0)),
    new Edge(new Point(1/2.,0,0),new Point(1/2.*cos(PI/3),1/2.*sin(PI/3),0)),
    new Edge(new Point(0,0,0),new Point(1/2.,0,0)),
    new Edge(new Point(1+1/2.*cos(PI/3),1/2.*sin(PI/3),0),new Point(1/2.*cos(PI/3),1/2.*sin(PI/3),0)),
    }
    ,
  new Edge[] {
    new Edge(new Point(1/2.*cos(PI/3),1/2.*sin(PI/3),0),new Point(0,0,0)),
    ...
    ,
  new Edge[] {
    new Edge(new Point(0,0,0),new Point(1/2.*cos(PI/3),1/2.*sin(PI/3),0)),
    new Edge(new Point(1/2.*cos(PI/3),1/2.*sin(PI/3),0),new Point(1/2.,0,0)),
    new Edge(new Point(1/2.,0,0),new Point(0,0,0))
    }
    ,
  new Edge[] {
    new Edge(new Point(0,0,0),new Point(1/2.*cos(PI/3),1/2.*sin(PI/3),0)),
    new Edge(new Point(1/2.*cos(PI/3),1/2.*sin(PI/3),0),new Point(1,0,0)),
    new Edge(new Point(1,0,0),new Point(0,0,0))
    }
    ,
  new Edge[] {
    new Edge(new Point(0,0,0),new Point(0.5,.5,0)),
    new Edge(new Point(0.5,0.5,0),new Point(1,0,0))
    }
    ,
    new Edge[] {
    new Edge(new Point(0,0,0),new Point(1./2*cos(PI/3),1./2*sin(PI/3),0)),
    new Edge(new Point(1./2*cos(PI/3),-1./2*sin(PI/3),0),new Point(0,0,0)),
    new Edge(new Point(1./2*cos(PI/3),1./2*sin(PI/3),0),new Point(1./2+1./2*cos(PI/3),1./2*sin(PI/3),0)),
    new Edge(new Point(1./2+1./2*cos(PI/3),-1./2*sin(PI/3),0),new Point(1./2*cos(PI/3),-1./2*sin(PI/3),0)),
    new Edge(new Point(1./2+1./2*cos(PI/3),1./2*sin(PI/3),0),new Point(1,0,0)),
    new Edge(new Point(1,0,0),new Point(1./2+1./2*cos(PI/3),-1./2*sin(PI/3),0))
    }
    ,
    new Edge[] {
    new Edge(new Point(0,0,0),new Point(1./3*cos(PI/3),1./3*sin(PI/3),0)),
    new Edge(new Point(1./3*cos(PI/3),-1./3*sin(PI/3),0),new Point(0,0,0)),
    new Edge(new Point(1./3*cos(PI/3),1./3*sin(PI/3),0),new Point(1./3+1./3*cos(PI/3),1./3*sin(PI/3),0)),
    new Edge(new Point(1./3+1./3*cos(PI/3),-1./3*sin(PI/3),0),new Point(1./3*cos(PI/3),-1./3*sin(PI/3),0)),
    new Edge(new Point(1./3+1./3*cos(PI/3),1./3*sin(PI/3),0),new Point(1,0,0)),
    new Edge(new Point(1,0,0),new Point(1./3+1./3*cos(PI/3),-1./3*sin(PI/3),0))
    }
    ,
  new Edge[] {
    new Edge(new Point(0,0,0),new Point(0.5,.5,0)),
    new Edge(new Point(0.5,0.5,0),new Point(1,0,0)),
    new Edge(new Point(0.5,-.5,0),new Point(0,0,0)),
    new Edge(new Point(1,0,0),new Point(0.5,-0.5,0))
    }
  };
...
void clean(float rr,float ss,float p) {
...
float getVar(Point center) {
  float sum=0;
  for (Edge e: edges){
    sum+=e.a.diff(center).rr();
    sum+=e.b.diff(center).rr();}
  return sum*0.5/edges.size();
} 
...
Model random_model() {
  ...
  return new Model(e,f,random(0.001,1));
}

Point rand_point(float span) {
  return new Point(random(-span,span),random(-span,span),0);
} 

Model mutate_model(Model mod) {
